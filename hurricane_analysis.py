# Goal: Work to write several functions that organize and manipulate data about Category 5 Hurricanes, the strongest hurricanes as rated by their wind speed.
...
def rate_hurricanes_by_damage(hurricanes):
    damage_rating_dict = {0:[],1:[],2:[],3:[],4:[],5:[], "Damages not recorded":[]}
    damage_scale = {0: 0,
                1: 100000000,
                2: 1000000000,
                3: 10000000000,
                4: 50000000000}
    for cane in hurricanes:
      #if something == Damages not recorded, do somthing else
        if hurricanes[cane]['Damages'] == "Damages not recorded":
              damage_rating_dict["Damages not recorded"].append(cane)
              continue 
